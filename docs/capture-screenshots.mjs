...
const SHOTS = [
  ...
  { id: "02-journal",          path: "/buchhaltung/journal" },
  { id: "03-konten",           path: "/buchhaltung/konten" },
  { id: "04-mandanten",        path: "/mandanten" },
  { id: "05-opos",             path: "/buchhaltung/opos" },
  { id: "06-mahnwesen",        path: "/buchhaltung/mahnwesen" },
  { id: "07-berichte",         path: "/berichte" },
  { id: "08-guv",              path: "/berichte/guv" },
  { id: "09-bwa",              path: "/berichte/bwa" },
  { id: "10-susa",             path: "/berichte/susa" },
  { id: "11-steuer-index",     path: "/steuern" },
  { id: "12-ustva",            path: "/umsatzsteuer/ustva" },
  { id: "13-euer",             path: "/buchhaltung/euer" },
  { id: "14-anlage-n",         path: "/einkommensteuer/anlage-n" },
  { id: "15-buchfuehrung",     path: "/buchhaltung/buchfuehrung" },

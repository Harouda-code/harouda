...
| **Arabisch** | التأمين الاجتماعي الإلزامي (المظلة القانونية لنظام الحماية الاجتماعية في ألمانيا — SGB IV — وتضم خمسة فروع مُستقلة: التأمين الصحي KV والتقاعدي RV وضد البطالة ALV والرعاية PV وإصابات العمل UV؛ اشتراكاتها إلزامية للموظفين الذين يتقاضون أكثر من حد أدنى معيّن، وتُقسَّم مناصفةً — paritätisch — بين صاحب العمل والموظف، ما عدا إصابات العمل التي يتحملها صاحب العمل وحده) |
...
| **Arabisch** | السجل الإلكتروني المركزي لبيانات الضريبة على الأجور (نظام اتحادي يديره مكتب الضرائب الاتحادي BZSt حلّ محلّ بطاقة ضريبة الأجور الورقية منذ 2013؛ يحتوي لكل موظّف على فئته الضريبية ومعاملاته — Faktor — واعتراف ديانته وعدد أطفاله وإعفاءاته الضريبية؛ صاحب العمل ملزم بسحب بيانات موظفيه إلكترونياً قبل أول راتب وبمراقبة أي تعديلات شهرياً) |
...
| **Arabisch** | العمل بأجر ضئيل (نوع من العمل بدوام جزئي في ألمانيا محدود قانوناً بسقف دخل شهري متحرك يرتبط بالحد الأدنى للأجور — حالياً 556 يورو — أو بفترة قصوى 3 أشهر / 70 يوم عمل سنوياً؛ معفى إلى حد بعيد من اشتراكات الموظّف في التأمين الصحي والبطالة، ويدفع صاحب العمل بدلاً عنه رسوماً مقطوعة إلى مركز الإبلاغ الاتحادي Minijob-Zentrale) |
...
| **Arabisch** | العمل في منطقة الاشتراك المخفّض الانتقالية (نظام بيني بين Minijob و العمل الكامل للأجور التي تتراوح بين 556.01 و 2000 يورو شهرياً تقريباً؛ يُخفَّض فيه اشتراك الموظّف في التأمينات الاجتماعية بصيغة انزلاقية — تبدأ بتخفيض كبير عند الحد الأدنى وتصل إلى المستوى الكامل عند الحد الأقصى — بينما يتحمّل صاحب العمل النسبة الكاملة) |
...
| **Arabisch** | الضريبة الجزافية على الأجور (صيغة بديلة لاحتساب ضريبة الأجور يختار فيها صاحب العمل دفع نسبة مئوية موحَّدة ثابتة — 2٪ أو 15٪ أو 20٪ أو 25٪ حسب الحالة — بدلاً من الاحتساب الفردي وفق ELStAM لكل موظف؛ يستخدم خاصة في Minijob وحفلات الشركات والمزايا العينية وتأمين المدخرات؛ الضريبة تخرج من جيب صاحب العمل لا الموظف) |
...
| **Arabisch** | أنظمة المساهمات الإلزامية على صاحب العمل (ثلاثة رسوم إضافية يدفعها صاحب العمل وحده — لا يشاركه الموظف فيها — وتمرّ عبر نفس قنوات الرواتب الشهرية: U1 لصندوق تعويض مرض الموظفين للشركات الصغيرة، و U2 لصندوق تعويض حماية الأمومة لجميع الشركات، و U3 لصندوق تعويض إعسار صاحب العمل الذي تديره وكالة العمل الاتحادية) |
...
| **Arabisch** | الرقم التأميني للموظف (معرّف إلزامي من 12 خانة يُصدره التأمين التقاعدي الفدرالي Deutsche Rentenversicherung لكل موظّف في بداية أول عمل مُسجَّل، ويُرافقه مدى الحياة؛ يُستخدم في كل إبلاغات DEÜV و ELStAM وكل مراسلات التأمينات الاجتماعية؛ يتكوَّن من رمز منطقة الإصدار + تاريخ الميلاد + حرف أول من اسم العائلة + رقم تسلسلي + رمز الجنس + خانة تحقّق) |

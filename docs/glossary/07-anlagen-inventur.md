...
| **Arabisch** | تكاليف الاقتناء وتكاليف التصنيع (القيمة الأولية التي يُدرَج بها الأصل في الميزانية وفق § 255 HGB؛ تُعرَّف Anschaffungskosten — AK — كإجمالي ما أُنفِق على اقتناء أصل مُشترى من الغير وجعله صالحاً للاستخدام وفق § 255 Abs. 1 HGB، شاملةً سعر الشراء + التكاليف العَرَضية Anschaffungsnebenkosten كالنقل والتركيب والشهادات والرسوم، ناقصاً خصومات البائع وتخفيضاته؛ أما Herstellungskosten — HK — فتُحتسب وفق § 255 Abs. 2, 3 HGB للأصول التي تُنتِجها المنشأة بنفسها وتشمل **حدّاً أدنى إلزامياً** من عناصر التكلفة — مواد وأجور مباشرة ومصاريف تصنيع غير مباشرة مناسبة وإهلاك — و**خيارات** بشأن تكاليف الإدارة وفوائد التمويل والتكاليف الاجتماعية الطوعية؛ AK/HK هي الأساس الذي يُبنى عليه كل حساب AfA وأحكام Teilwert لاحقاً) |
...
| **Arabisch** | الإهلاك الضريبي المنتظم (الآلية التي يُوزَّع بموجبها AK/HK لأصل ثابت على مدار سنوات Nutzungsdauer بصورة نظامية وفق § 7 EStG؛ الصيغة الأكثر شيوعاً — وعادةً الوحيدة المسموحة ضريبياً في الوقت الحاضر — هي Lineare AfA وفق § 7 Abs. 1 EStG بتقسيم متساوٍ على سنوات العمر الإنتاجي؛ تُضاف إليها حالات خاصة: Degressive AfA وفق § 7 Abs. 2 EStG — متناقصة المعدل — وهي متاحة فقط في فترات تشريعية محددة لأسباب اقتصادية، Leistungs-AfA وفق § 7 Abs. 1 Satz 6 EStG لآلات يمكن قياس استخدامها بوحدات إنتاج، Gebäude-AfA وفق § 7 Abs. 4, 5 EStG بمعدلات ثابتة قانونياً للعقارات؛ يبدأ تسجيل AfA من شهر الاقتناء Monatsgenaue Berechnung وفق § 7 Abs. 1 Satz 4 EStG؛ في Handelsbilanz تُعرَف بنفس المفهوم تحت مسمى «planmäßige Abschreibung» وفق § 253 Abs. 3 HGB) |
...
| **Arabisch** | الأصول منخفضة القيمة (الأصول الثابتة القابلة للاستخدام المستقل والمتحركة والقابلة للإهلاك، التي لا تتجاوز AK/HK الصافية قيمتها 800 يورو، وتُخصَم بالكامل كمصروف تشغيلي في سنة الاقتناء وفق § 6 Abs. 2 EStG بدلاً من إهلاكها على مدار Nutzungsdauer؛ عتبة 800 يورو هي **صافي** — أي بدون ضريبة القيمة المضافة القابلة للخصم — سارية منذ 01.01.2018 بعد رفعها من 410 يورو؛ على الرغم من اقتراح قانون فرص النمو Wachstumschancengesetz لرفعها إلى 1000 يورو، إلا أن هذا الرفع أُسقِط في النسخة النهائية المُقرَّة في مارس 2024 لأسباب تتعلق بالميزانية الاتحادية، وبقيت العتبة عند 800 يورو؛ الحالات > 250 يورو تستلزم قيدها في GWG-Verzeichnis مستقل وفق § 6 Abs. 2 Satz 4 EStG؛ الخيار بين GWG و Sammelposten حصري لكامل السنة المالية) |
...
| **Arabisch** | مجمع الأصول متوسطة القيمة (آلية تبسيط محاسبي-ضريبي وفق § 6 Abs. 2a EStG: كل الأصول الثابتة القابلة للاستخدام المستقل والمتحركة التي تتراوح AK/HK صافيها بين **250.01 يورو و 1.000 يورو** تُجمَّع في مجمع سنوي Sammelposten ويُهلَك هذا المجمع بالكامل على مدار 5 سنوات بمعدل خطي 20% سنوياً، بصرف النظر عن Nutzungsdauer الفردية للعناصر ومهما كانت مدة بقائها الفعلي في الخدمة؛ الحدود ثابتة منذ 01.01.2010 — سبقها فترة 150–1.000 يورو بين 2008–2009 — ولم تُغيَّر بموجب Wachstumschancengesetz رغم اقتراح رفع الحد الأعلى إلى 5.000 يورو؛ الخيار بين Sammelposten و GWG-Sofortabzug حصري لكامل السنة، ويُتَّخَذ سنوياً لجميع الأصول الواقعة في نطاق التداخل 250–800 يورو؛ ميزة Sammelposten المعمارية: بقاء المجمع السنوي قائماً حتى نهاية فترة 5 سنوات حتى لو استُبعِد بعض عناصره — لا يوجد Abgangsbuchung فردية) |
...
| **Arabisch** | القيمة الجزئية والإهلاك الاستثنائي إلى القيمة الجزئية (Teilwert — التعريف الضريبي وفق § 6 Abs. 1 Nr. 1 Satz 3 EStG: المبلغ الذي سيدفعه مشترٍ افتراضي للمنشأة بأكملها مقابل هذا الأصل الفردي في إطار استمرارية المنشأة Going Concern؛ Teilwertabschreibung — الإهلاك الاستثنائي وفق § 6 Abs. 1 Nr. 1 Satz 2 EStG: يسمح بخفض القيمة الدفترية إلى Teilwert الأدنى عندما يكون الانخفاض في القيمة **دائماً** voraussichtlich dauernde Wertminderung؛ في Handelsbilanz وفق § 253 Abs. 3 Satz 5 HGB تكون outside-plan-abschreibung إلزامية للأصول الثابتة عند الانخفاض الدائم، بينما في Steuerbilanz بعد BilMoG 2009 أصبحت خياراً لا إلزاماً — هذا هو الوضع المعاكس للقاعدة العادية حيث HB تسمح و SB تُلزِم؛ Wertaufholungsgebot — وجوب رفع القيمة مرة أخرى عند زوال أسباب الانخفاض وفق § 253 Abs. 5 Satz 1 HGB في الحسابات التجارية و § 6 Abs. 1 Nr. 1 Satz 4 EStG في الحسابات الضريبية) |
...
| **Arabisch** | عملية الجرد الفعلي (**الإجراء** الميداني لإحصاء وقياس وتقييم عناصر Vermögen — الأصول — و Schulden — الالتزامات — كمقدمة واجبة لإعداد مستند Inventar وفق § 241 HGB؛ تُميَّز عن Inventar — **الوثيقة** — كما يُميَّز الفعل عن نتيجته؛ تتنوع أشكالها: Vollinventur التقليدية بتاريخ القطع Stichtag، و Stichprobeninventur بالأساليب الإحصائية المعتمدة وفق § 241 Nr. 1 HGB، و Permanente Inventur القائمة على الدفاتر مع فحص دوري وفق § 241 Nr. 2 HGB، و Verlegte Inventur بانزياح محدود قبل/بعد تاريخ القطع وفق § 241 Nr. 3 HGB ضمن نطاق زمني 10 أيام؛ يُدمَج في هذا الإدخال **Festwert-Verfahren وفق § 240 Abs. 3 HGB** كأسلوب تبسيط خاص بالأصول الثابتة والمواد الخام ذات التغير البطيء في القيمة والكمية والتركيب — يُسمَح بإبقاء قيمة ثابتة Festwert لها في Bilanz مع إجراء Vollinventur دورية كل 3 سنوات كحد أقصى وفق R 5.4 Abs. 3 EStR) |

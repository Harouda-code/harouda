...
|---|---|---|---|---|---|
| **A. Cloud-API** (externe Anbieter) | 🟡 Daten verlassen Server; AVV + Sub-Processor-Kette nötig; StBerG § 57 rechtlich belastet | ✅ sehr hoch | ✅ niedrig | 🟡 0,05–0,20 €/Beleg laufend (~500–2.000 €/Jahr) | ❌ **abgelehnt** — Verschwiegenheitspflicht-Risiko |
...
**Nicht verwechseln mit:**
- **Cloud-APIs** (externe Anbieter) — Option A, wegen StBerG/DSGVO abgelehnt

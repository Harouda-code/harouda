...
export const COMMANDS: CommandEntry[] = [
  // --- Erstellen ---------------------------------------------------------
  {
    ...
    contextPaths: ["/buchhaltung/journal"],
    hint: "Journal",
  },
  {
  ...
  { id: "cmd.rep.gewst", label: "Gewerbesteuer", keywords: ["gewerbe"], category: "report", to: "/steuern/gewerbesteuer" },
  { id: "cmd.rep.kst", label: "Körperschaftsteuer", keywords: ["körperschaft"], category: "report", to: "/steuern/kst" },

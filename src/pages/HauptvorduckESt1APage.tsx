...
const ANLAGE_LINKS: AnlageLink[] = [
  { to: "/einkommensteuer/anlage-n", label: "Anlage N · Arbeitslohn", formId: "anlage-n" },
  { to: "/einkommensteuer/anlage-n-aus", label: "Anlage N-AUS · ausl. Arbeitslohn", formId: "anlage-n-aus" },
  { to: "/einkommensteuer/anlage-n-dhf", label: "Anlage N-DHF · Doppelte Haushaltsführung", formId: "anlage-n-dhf" },
  { to: "/einkommensteuer/anlage-s", label: "Anlage S · selbst. Arbeit", formId: "anlage-s" },
  { to: "/einkommensteuer/anlage-g", label: "Anlage G · Gewerbe", formId: "anlage-g" },
  { to: "/einkommensteuer/anlage-v", label: "Anlage V · Vermietung", formId: "anlage-v" },
  { to: "/einkommensteuer/anlage-v-sonstige", label: "Anlage V-Sonstige", formId: "anlage-v-sonstige" },
  { to: "/einkommensteuer/anlage-v-fewo", label: "Anlage V-FeWo · Ferienwohnung", formId: "anlage-v-fewo" },
  { to: "/einkommensteuer/anlage-so", label: "Anlage SO · sonstige Einkünfte", formId: "anlage-so" },
  { to: "/einkommensteuer/anlage-r", label: "Anlage R · Renten Inland", formId: "anlage-r" },
  { to: "/einkommensteuer/anlage-rav-bav", label: "Anlage R-AV/bAV · Riester/Rürup/bAV", formId: "anlage-rav-bav" },
  { to: "/einkommensteuer/anlage-kap", label: "Anlage KAP · Kapitalvermögen", formId: "anlage-kap" },
  { to: "/einkommensteuer/anlage-aus", label: "Anlage AUS · ausl. Einkünfte", formId: "anlage-aus" },
  { to: "/einkommensteuer/anlage-vorsorge", label: "Anlage Vorsorgeaufwand", formId: "anlage-vorsorge" },
  { to: "/einkommensteuer/anlage-av", label: "Anlage AV · Riester", formId: "anlage-av" },
  { to: "/einkommensteuer/anlage-sonder", label: "Anlage Sonderausgaben", formId: "anlage-sonder" },
  { to: "/einkommensteuer/anlage-agb", label: "Anlage Außergewöhnliche Belastungen", formId: "anlage-agb" },
  { to: "/einkommensteuer/anlage-kind", label: "Anlage Kind", formId: "anlage-kind" },
  { to: "/einkommensteuer/anlage-u", label: "Anlage U · Realsplitting", formId: "anlage-u" },
  { to: "/einkommensteuer/anlage-unterhalt", label: "Anlage Unterhalt", formId: "anlage-unterhalt" },
  { to: "/einkommensteuer/anlage-haa", label: "Anlage Haushaltsnahe Aufwendungen", formId: "anlage-haa" },
  { to: "/einkommensteuer/anlage-em", label: "Anlage Energetische Maßnahmen", formId: "anlage-em" },
  { to: "/einkommensteuer/anlage-mobility", label: "Anlage Mobilitätsprämie", formId: "anlage-mobility" },
];
